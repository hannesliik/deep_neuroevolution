# https://github.com/openai/gym/tree/master/gym/utils
...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None, get_action_fn=None):
